...
public class RecordExcludeImpl extends RecordOperationImpl implements RecordExclude
{
    ...
    if (field != null && field.eIsProxy())
    {
      ...
      if (field != oldField)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SwrtjPackage.RECORD_EXCLUDE__FIELD, oldField, field));
      }
    }
    return field;
  }
  ...
  public void setField(FieldName newField)
  {
    ...
    field = newField;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SwrtjPackage.RECORD_EXCLUDE__FIELD, oldField, field));
  }
