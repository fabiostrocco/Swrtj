...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Trait Alias</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.example.swrtj.impl.TraitAliasImpl#getOriginalMethod <em>Original Method</em>}</li>
 *   <li>{@link org.xtext.example.swrtj.impl.TraitAliasImpl#getNewMethod <em>New Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TraitAliasImpl extends TraitOperationImpl implements TraitAlias
{
  /**
  ...
  {
    return SwrtjPackage.Literals.TRAIT_ALIAS;
  }
    ...
    if (originalMethod != null && originalMethod.eIsProxy())
    {
      ...
      if (originalMethod != oldOriginalMethod)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SwrtjPackage.TRAIT_ALIAS__ORIGINAL_METHOD, oldOriginalMethod, originalMethod));
      }
    }
  ...
  public void setOriginalMethod(MethodName newOriginalMethod)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SwrtjPackage.TRAIT_ALIAS__ORIGINAL_METHOD, oldOriginalMethod, originalMethod));
  }
  ...
  public NotificationChain basicSetNewMethod(MethodName newNewMethod, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SwrtjPackage.TRAIT_ALIAS__NEW_METHOD, oldNewMethod, newNewMethod);
  ...
  public void setNewMethod(MethodName newNewMethod)
  {
    if (newNewMethod != newMethod)
    {
      ...
      if (newMethod != null)
        msgs = ((InternalEObject)newMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SwrtjPackage.TRAIT_ALIAS__NEW_METHOD, null, msgs);
      if (newNewMethod != null)
        msgs = ((InternalEObject)newNewMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SwrtjPackage.TRAIT_ALIAS__NEW_METHOD, null, msgs);
      msgs = basicSetNewMethod(newNewMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SwrtjPackage.TRAIT_ALIAS__NEW_METHOD, newNewMethod, newNewMethod));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SwrtjPackage.TRAIT_ALIAS__NEW_METHOD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SwrtjPackage.TRAIT_ALIAS__ORIGINAL_METHOD:
