...
public class TraitFieldRenameImpl extends TraitOperationImpl implements TraitFieldRename
{
    ...
    if (originalField != null && originalField.eIsProxy())
    {
      ...
      if (originalField != oldOriginalField)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SwrtjPackage.TRAIT_FIELD_RENAME__ORIGINAL_FIELD, oldOriginalField, originalField));
      }
    }
  ...
  public void setOriginalField(FieldName newOriginalField)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SwrtjPackage.TRAIT_FIELD_RENAME__ORIGINAL_FIELD, oldOriginalField, originalField));
  }
  ...
  public void setNewField(FieldName newNewField)
  {
    if (newNewField != newField)
    {
      ...
      if (newField != null)
        msgs = ((InternalEObject)newField).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SwrtjPackage.TRAIT_FIELD_RENAME__NEW_FIELD, null, msgs);
      if (newNewField != null)
        msgs = ((InternalEObject)newNewField).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SwrtjPackage.TRAIT_FIELD_RENAME__NEW_FIELD, null, msgs);
      msgs = basicSetNewField(newNewField, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SwrtjPackage.TRAIT_FIELD_RENAME__NEW_FIELD, newNewField, newNewField));
  }
